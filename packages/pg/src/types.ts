...
// types.setTypeParser(OID.inet as any, defaultParserMappings[OID.inet].parse);
// types.setTypeParser(OID._inet as any, defaultParserMappings[OID._inet].parse);
// types.setTypeParser(OID.cidr as any, defaultParserMappings[OID.cidr].parse);
// types.setTypeParser(OID._cidr as any, defaultParserMappings[OID._cidr].parse);

// types.setTypeParser(OID.macaddr as any, defaultParserMappings[OID.macaddr].parse);
// types.setTypeParser(OID._macaddr as any, defaultParserMappings[OID._macaddr].parse);

// types.setTypeParser(OID.macaddr8 as any, defaultParserMappings[OID.macaddr8].parse);
// types.setTypeParser(OID._macaddr8 as any, defaultParserMappings[OID._macaddr8].parse);
