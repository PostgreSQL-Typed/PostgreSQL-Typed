import { defineGraph, defineLink, defineNode, GraphController, type Graph, type GraphConfig, type GraphLink, type GraphNode } from "d3-graph-controller";
...
export function getRelationGraph(): RelationGraph {
	...
	if (!table) return defineGraph<RelationType, RelationNode, RelationLink>({ nodes: [], links: [] });
