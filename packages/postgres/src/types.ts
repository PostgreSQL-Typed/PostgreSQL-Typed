...
export const types: Record<string, postgres.PostgresType<any>> = {
	bit: {
		to: OID.bit,
		from: [OID.bit],
		serialize: (value: string | null) => parser<Bit<number>>(Bit)(value)?.value ?? null,
		parse: parser<Bit<number>>(Bit),
	},
	_bit: {
		to: OID._bit,
		from: [OID._bit],
		serialize: (value: string | null) => (value === null ? null : JSON.stringify(arrayParser<Bit<number>>(Bit, ",")(value)?.map(v => v.value))),
	...
	char: {
		to: OID.char,
		from: [OID.char],
		serialize: (value: string | null) => parser<Character<number>>(Character)(value)?.value ?? null,
		parse: parser<Character<number>>(Character),
	},
	_char: {
		to: OID._char,
		from: [OID._char],
		serialize: (value: string | null) => (value === null ? null : JSON.stringify(arrayParser<Character<number>>(Character, ",")(value)?.map(v => v.value))),
